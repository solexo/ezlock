          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <div className="p-6 bg-gray-50  rounded-lg">
                <h3 className="font-bold text-gray-900  mb-2">Portée Étendue</h3>
                <p className="text-gray-600 ">Lecture à longue distance pour une efficacité maximale.</p>
              </div>
              <div className="p-6 bg-gray-50  rounded-lg">
                <h3 className="font-bold text-gray-900  mb-2">Haute Vitesse</h3>
                <p className="text-gray-600 ">Traitement rapide de multiples tags simultanément.</p>
              </div>
              <div className="p-6 bg-gray-50  rounded-lg">
